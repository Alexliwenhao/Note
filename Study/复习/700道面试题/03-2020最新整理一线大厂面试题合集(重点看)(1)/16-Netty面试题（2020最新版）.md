...
用什么样的通道将数据发送给对方，BIO、NIO或者AIO，I/O模型在很大程度上决定了框架的性能阻塞I/O 传统阻塞型I/O(BIO)可以用下图表示：![IO模型](IO模型.jpg)
...
![Reactor多线程模型](Study/复习/700道面试题/03-2020最新整理一线大厂面试题合集(重点看)(1)/16-Netty面试题（2020最新版）.assets/Reactor多线程模型.jpg)
