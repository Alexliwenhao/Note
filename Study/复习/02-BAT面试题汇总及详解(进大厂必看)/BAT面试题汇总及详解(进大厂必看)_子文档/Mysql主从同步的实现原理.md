...
![2017031315163835](Study/复习/02-BAT面试题汇总及详解(进大厂必看)/BAT面试题汇总及详解(进大厂必看)_子文档/Mysql主从同步的实现原理.assets/2017031315163835.png)
...
![2017031315163936](Study/复习/02-BAT面试题汇总及详解(进大厂必看)/BAT面试题汇总及详解(进大厂必看)_子文档/Mysql主从同步的实现原理.assets/2017031315163936.png)

如图，在slave机器上查看I/O、SQL线程。

![2017031315164037](Study/复习/02-BAT面试题汇总及详解(进大厂必看)/BAT面试题汇总及详解(进大厂必看)_子文档/Mysql主从同步的实现原理.assets/2017031315164037.png)

**4、讲了这么多，一图以蔽之**

![2017031315164038](Study/复习/02-BAT面试题汇总及详解(进大厂必看)/BAT面试题汇总及详解(进大厂必看)_子文档/Mysql主从同步的实现原理.assets/2017031315164038.png)